...
Your thoughts...
```
I recently chaired a session at our graduate student music conference at the Faculty of Music at UofT, and a student gave a paper about the ethics surrounding Spotify algorithms, so the idea of ethics of databases has recently been on my mind. The “recommended” and AI-generated playlists, songs, and albums that Spotify generates has been a topic of conversation and debate amongst myself and many of my colleagues and friends. I have heard the argument from people like this speaker from the conference and other passionate folk that these algorithms keep lesser-known artists from getting recognition or attention and also keep people from discovering/finding music in a more natural way (from searching through records to talking and sharing music with friends). Moreover, Spotify and many other streaming platforms, like Netflix and YouTube, etc. want as many views, clicks, and time as possible on their services since this is what generates revenue for their companies. I also acknowledge that features like “Spotify Wrapped” also carry a certain social capital when shared at the end of a calendar year through social media, and thus Spotify is also tapping into the social relationships and dynamics of people’s lives (and psychologies) and profiting off it. Further, there are arguments that these are business, but we are all buying into it, which means many of us are contributors to the system and the cycle. I agree with these observations, however I also want to reflect that I have discovered many independent and lesser known artists on Spotify because of what it recommends to me. These artists mostly consist of women, people of colour, trans, and gender fluid artists. I am at once thrilled to discover these artists, but also a little unnerved that Spotify would “know” this about me. Indeed, I also find it very interesting to see what the most popular songs/albums/artists people connect with the most as this is a curiosity I explore within my own research (and I am grateful this data exists). None of this is to say I am on one side of the argument or another, but rather that I think each individual first has a choice to engage/buy into these services to start, and that it difficult to view something as fully evil or void of fairness, inequality, or marginalization.